      ...
      <div class="flex flex-col items-center justify-center">
        ...
        >
          ...
          <div class="mt-6 w-full">
            ...
            <div v-if="passwordError" class="text-[12px] text-red-400">
              {{ passwordError }}
            </div>
          </div>
          <!-- Select -->
          <div class="mt-6 w-full">
            ...
            <select v-model="role" class="ml-6" name="" id="">
          ...
          <div class="mt-6 w-full">
            ...
            <div v-if="skills.length" class="mt-3 flex flex-wrap gap-3">
              <div
          ...
          <div id="term" class="mt-6 w-full">
            ...
            />
            <label
              class="ml-3 text-sm font-medium leading-none text-gray-800"
              for=""
...
import RadioSmall from "./RadioSmall.vue";
export default {
  components: { RadioSmall, Dropdown },
  data() {
    return {
      email: "",
      password: "",
  ...
  methods: {
    addSkill(e) {
      if (e.key === "," && this.tempSkill) {
        if (
          !this.skills.includes(this.tempSkill.slice(0, -1)) &&
